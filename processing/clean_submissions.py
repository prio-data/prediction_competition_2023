    ...
    for target in targets:
        for window in windows:
            if any(
                ...
                save_path = save_base / target / f"window={window}"
...
def clean_all_submissions(
    ...
    for submission in tqdm(submissions, desc="Cleaning submissions"):
        try:
